...
import { locations } from '../../../../data/switzerland/switzerland';
import '../../../../styles/styles.css';
import 'tachyons';

export default class Switzerland extends Component {
  state = {
  }
  ...
  render() {
    ...
    return (
      <div>
        <div className='tc'>
          <h1 className='f1' data-test='page-header'>Switzerland</h1>
