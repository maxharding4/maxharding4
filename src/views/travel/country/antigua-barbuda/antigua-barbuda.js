...
import { locations } from '../../../../data/antigua-barbuda/antigua-barbuda';
import '../../../../styles/styles.css';
import 'tachyons';

export default class AntiguaBarbuda extends Component {
  state = {
  }
  ...
  render() {
    ...
    return (
      <div>
        <div className='tc'>
          <h1 className='f1' data-test='page-header'>Antigua & Barbuda</h1>
