...
import { photos } from '../../../../data/antigua-barbuda/antigua-accommodation';

import '../../../../styles/styles.css';
import 'tachyons';

export default class AntiguaAccom extends Component {
  state = {
  }
  ...
  render() {
    ...
    return (
      <div>
        <div className='tc'>
          <h1 className='f1' data-test='page-header'>Antigua accomodation</h1>
          <Scroll>
            <ErrorBoundry>
