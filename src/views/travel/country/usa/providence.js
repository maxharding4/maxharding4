...
import { photos } from '../../../../data/usa/providence';

import '../../../../styles/styles.css';
import 'tachyons';

export default class Providence extends Component {
  state = {
  }
  ...
  render() {
    ...
    return (
      <div>
        <div className='tc'>
          <h1 className='f1' data-test='page-header'>Providence, United States</h1>
