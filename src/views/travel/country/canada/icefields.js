...
import { photos } from '../../../../data/canada/icefields';

import '../../../../styles/styles.css';
import 'tachyons';

export default class Icefields extends Component {
  state = {
  }
  ...
  render() {
    ...
    return (
      <div>
        <div className='tc'>
          <h1 className='f1' data-test='page-header'>Icefields Parkway, Canada</h1>
